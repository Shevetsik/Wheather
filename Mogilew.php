...
<head>
    <meta charset="UTF-8">
    <title>Weather in Mahilyow</title>
    ...
    .center-content {
        ...
        #weatherIcon {
            box-shadow: 0 5 0px rgba(0, 0, 0, 0.5);
        }
        ...
        body {
            background-image: url("/Pogoda/images/MogilewBlur3.jpg");
...
<div class="center-content">
    <h5>Погода в Могилёве на <p id="datetime"></p></h5>
    ...
    async function fetchWeather() {
        ...
        if (data.cod === '404') {
            ...
            document.getElementById('weatherDisplay').innerHTML = `
                ...
                <img id="weatherIcon" src="http://openweathermap.org/img/wn/${weatherIcon}@2x.png" alt="Weather icon" />
            `;
